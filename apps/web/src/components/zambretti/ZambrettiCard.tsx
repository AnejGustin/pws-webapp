...
export default function ZambrettiCard() {
    ...
    const forecastTime = formatTime(zambrettiForecastData.created_at, WEATHER_STATION_TIMEZONE);
    const forecastText = zambrettiForecastData.forecast_text;
    const { icon, iconAlt, trend, trendAlt } = forecastTextToIconProps[forecastText];
    ...
    return (
        <Card
            ...
            onMouseLeave={stopIconsAnimation}
        >
